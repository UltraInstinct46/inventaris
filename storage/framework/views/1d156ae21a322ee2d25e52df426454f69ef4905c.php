         ...
         <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="nama_ruang" class="form-control" value="<?php echo e($ruang->nama_ruang); ?>">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Kode ruang:</strong>
                    <input type="text" name="kode_ruang" class="form-control" placeholder="Rombel" value="<?php echo e($ruang->kode_ruang); ?>">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Keterangan:</strong>
                    <textarea type="text" name="keterangan" class="form-control" placeholder="Rombel" value="<?php echo e($ruang->keterangan); ?>"><?php echo e($ruang->keterangan); ?></textarea>
                </div>
            </div>
