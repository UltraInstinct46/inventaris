...
<form action="<?php echo e(route('detailpinjams.store')); ?>" method="POST" class="text-center border border-black p-5">
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('detailpinjams.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\inventaris\resources\views/detailpinjams/create.blade.php ENDPATH**/ ?>